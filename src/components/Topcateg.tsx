...
function TopCategories() {
  const categories = [
    { id: 1, img: "/image2.png", name: "Mini LCW Chair", price: "$56.00" },
    { id: 2, img: "/image3.png", name: "Mini LCW Chair", price: "$56.00" },
    { id: 3, img: "/image1.png", name: "Mini LCW Chair", price: "$56.00" },
    { id: 4, img: "/image4.png", name: "Mini LCW Chair", price: "$56.00" },
  ];
