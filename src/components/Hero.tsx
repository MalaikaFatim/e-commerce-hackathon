...
function Hero() {
  ...
  return (
    <div className="relative w-full bg-purple-50 overflow-hidden flex flex-col md:flex-row items-center justify-between">
      ...
      <div className="w-full md:w-1/2 h-full relative flex flex-col items-center justify-start">
        ...
        {/* Blue Discount Badge */}
        <div
          className="absolute top-[40px] right-[75px] bg-blue-500 rounded-full bg-cover bg-center w-[80px] h-[80px] flex flex-col justify-center items-center z-20"
