      ...
      <div className="w-full max-w-[1200px] flex items-center justify-between px-4">
        ...
        <div className="flex items-center justify-center gap-6 w-full sm:w-auto">
          ...
          >
            ...
            {currencyDropdown && (
              <div className="absolute top-8 bg-white text-black rounded shadow-md p-2">
                <div className="hover:bg-pink-500 px-4 py-1 cursor-pointer">USD</div>
                <div className="hover:bg-pink-500 px-4 py-1 cursor-pointer">EUR</div>
                <div className="hover:bg-pink-500 px-4 py-1 cursor-pointer">GBP</div>
              </div>
            )}
          </div>
         ...
         <Link href="/Page/Login"  className='flex text-gray-200 hover:text-pink-500 transition'>
              Login
          </Link>  
            
          {/* Wishlist */}
          <a href="/wishlist" className="flex items-center gap-2 cursor-pointer hover:text-pink-500">
            <FaHeart />
            <span>Wishlist</span>
          </a>

          {/* Cart */}
          <a href="/Page/Cart/page" className="cursor-pointer hover:text-pink-500">
            <FaShoppingCart />
          </a>
        </div>
      </div>
