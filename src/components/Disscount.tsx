...
const Discount = () => {
  return (
    ...
    <section className="flex flex-col items-center  justify-center py-12 px-4 lg:flex-row lg:justify-between lg:px-16 bg-purple-100">
      {/* Left Content */}
      <div className="lg:w-1/2 text-center lg:text-left">
        {/* Main Heading */}
        
        <h1 className="text-3xl font-bold text-blue-900 text-center mb-6">Discount Item</h1>
      ...
      {/* Right Image */}
      <div className="mt-0 lg:mt-0 lg:w-1/2 flex justify-cente ">
           <img src="/image.png" alt="Sofa" className="max-w-full h-auto" />
