...
const cartproducts: CartItem[] = [
  {
    ...
    color: "Red",
    size: "M",
    image: "/cart/img1.png", // Updated image filename
  },
  {
    id: 2,
    name: "Product 2",
    ...
    color: "Blue",
    size: "L",
    image: "/cart/img2.png", // Updated image filename
  },

  {
      ...
      color: "Blue",
      size: "L",
      image: "/cart/img3.png", // Updated image filename
    },

    {
      ...
      color: "Blue",
      size: "L",
      image: "/cart/img4.png", // Updated image filename
    },

    {
      ...
      color: "Blue",
      size: "L",
      image: "/cart/img5.png", // Updated image filename
    },
];
...
const Cart = () => {
  ...
  return (
      ...
      <div className="py-16 ml-18 bg-white lg:ml-36 space-y-2">
        <h1 className="text-4xl font-bold text-[#001F54]">Cart</h1> {/* Dark blue */}
    ...
    <div className="p-6 lg:p-12 grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div className="p-6 bg-gray-50 rounded-md shadow-md flex flex-col justify-between">
        ...
        <div className="p-6 bg-gray-50 rounded-md shadow-md">
          <h2 className="text-xs font-bold mb-4 text-[#1D3178]  sm:text-xl">Calculate Shipping</h2>
          <input
            type="text"
